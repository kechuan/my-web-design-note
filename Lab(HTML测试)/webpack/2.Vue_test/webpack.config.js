...
const VueLoaderPlugin = require("vue-loader");			//引入清理默认输出环境
const WebpackBar = require('webpackbar');

const Vue_webpage = new Htmlplugin({	//因为其是一个实例函数 所以你需要new一个来调用 并指定其参数
	template: './src/index.html',
	filename: './index.html',
	title:'this is Vue test webpage',
...
module.exports = {
	...
	resolve:{
		alias:{
			...
			"vue$":path.resolve(__dirname,"node_modules/vue/dist/vue.global.js") //将js下的vue引入重新指向以下的目录
			//一般的import 好像只会引入到 runtime库
		}
	},
	plugins: [Vue_webpage,cleanPlugin,progressBar],	//最后通过打包的插件节点引入第三方插件
	optimization:{
